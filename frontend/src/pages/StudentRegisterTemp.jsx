...
function StudentRegisterTemp() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("SUBMIT REGISTER ELEVE déclenché");
    ...
    try {
      ...
      console.log("STATUS HTTP REGISTER ELEVE :", response.status);

      const data = await response.json();
      console.log("REPONSE BACKEND REGISTER ELEVE :", data);
      ...
      console.error("Erreur register élève :", error);
